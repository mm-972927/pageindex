...
#             tags=["pageindex", "index"],
#         )
#         t.generation(
#             name="toc_build",
#             model="claude-sonnet-4-20250514",
#             input=f"{doc_name} — {total_pages} pages",
#             output=f"{total_nodes} ToC nodes",
...
#     """
#     Usage in app.py:
#         qt = QueryTrace(session_id, doc_name, query)
#         # ... run retrieval ...
#         qt.log_toc_reasoning(...)
#         qt.log_page_retrieval(...)
#         qt.log_answer_gen(...)
#         qt.finish(answer, total_tokens)
#     """
...
#                 session_id=session_id,
#                 input={"query": query, "doc": doc_name},
#                 tags=["pageindex", "query"],
#             )
#         except Exception:
#             pass
...
#                 name="toc_reasoning",
#                 model="claude-sonnet-4-20250514",
#                 input={"toc_nodes": nodes_count},
#                 output={"primary": primary_id, "secondary": secondary_ids,
...
#             self._trace.span(
#                 name="page_retrieval",
#                 input={"nodes": [n["node_id"] for n in nodes_read]},
#                 output={"pages_fetched": pages_fetched, "chars": chars},
#             )
#         except Exception:
#             pass
...
#                     "total_latency_sec": round(time.time() - self._t0, 2),
#                 },
#             )
#             lf.flush()
#         except Exception:
